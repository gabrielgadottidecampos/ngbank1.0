                                                ...
                                                <form method="POST" action="" @submit.prevent="login($event)">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="email" name="email" class="form-style"
                                                               placeholder="Seu Email" id="logemail" required
                                                               autocomplete="email" autofocus v-model="email">
                                                        <i class="input-icon uil uil-at"></i>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <input type="password" class="form-style"
                                                               placeholder="Sua Senha" name="password" required
                                                               autocomplete="current-password" v-model="password">
                                                        <i class="input-icon uil uil-lock-alt"></i>
                                                    </div>
                                                    <button type="submit" class="btn1 btn-primary mt-4">
                                                        Login
                                                    </button>

                                                    <p class="mb-0 mt-4 text-center"><a href="#0" class="link">Esqueceu
                                                        sua Senha?</a></p>
                                                </form>
                                            </div>
                                        </div>
                                            ...
                                            <div class="section text-center">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="logname" class="form-style"
                                                           placeholder="Seu Nome Completo" id="logname"
                                                           autocomplete="off">
                                                ...
                                                <a href="#" class="btn1 mt-4">Cadastrar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
